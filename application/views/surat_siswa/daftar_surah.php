<div class="content-wrapper">
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
						<a href="<?= base_url() ?>surat_siswa/show/<?= $this->uri->segment(6) ?>/<?= $this->uri->segment(4) ?>/<?= $this->uri->segment(5) ?>" class="btn btn-warning btn-sm" style="margin-bottom: 10px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
        ...
        <div class="box-body" style="overflow-x: scroll; ">
          ...
          <input type="hidden" name="semester"  id="semester" value="<?= $this->uri->segment(5) ?>">
					<input type="hidden" name="kelompok_id"  id="kelompok_id" value="<?= $this->uri->segment(6) ?>">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $.ajax({
           ...
           method:"POST",
           data:{siswa_id:siswa_id,tahun_ajaran_id:tahun_ajaran_id,semester:semester,kelompok_id:kelompok_id},
