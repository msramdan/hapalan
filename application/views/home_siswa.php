          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu logged-user-menu">
                <li><a href="<?= site_url('pannel_siswa/edit') ?>"><i class="ti-user"></i> <span>Edit Profile</span></a></li>
    ...
    <div id="sidebar-nav" class="sidebar">
      <nav>
        <ul class="nav" id="sidebar-nav-menu">
          <li><a href="<?= base_url() ?>pannel_siswa"><i class="ti-pencil-alt"></i> <span class="title">Penilaian</span></a></li>
          <li><a href="<?= site_url('pannel_siswa/edit') ?>"><i class="fa fa-user"></i> <span class="title">Edit Profile</span></a></li>
