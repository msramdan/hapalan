...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Tingkat Id <?php echo form_error('tingkat_id') ?></td><td><input type="text" class="form-control" name="tingkat_id" id="tingkat_id" placeholder="Tingkat Id" value="<?php echo $tingkat_id; ?>" /></td></tr>
